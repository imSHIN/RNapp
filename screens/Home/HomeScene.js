...
import HomeMenuView2 from './HomeMenuView2'
...
class HomeScene extends PureComponent<Props, State> {
    ...
    onCellSelected = (info: Object) => {
        ...
        this.props.navigation.navigate('GroupPurchase2', {info: info})
    }
    ...
    renderHeader = () => {
        return (
            <View>
                ...
                <HomeMenuView2 menuInfos={api.menuInfo} onMenuSelected={this.onMenuSelected} />
                <SpacingView />
                {/* <HomeGridView infos={this.state.discounts} onGridSelected={(this.onGridSelected)} />
                <SpacingView /> */}
                <View style={styles.recommendHeader}>
                    <Heading3>职位推荐</Heading3>
                </View>
            </View>
        )
    }
